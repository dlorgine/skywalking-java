...
public class CatContextManagerExtendService extends ContextManagerExtendService implements
        CatConnectionStatusListener {

    @Override
    public void prepare() {
        ServiceManager.INSTANCE.findService(CatProducerManager.class).addListener(this);
    }
